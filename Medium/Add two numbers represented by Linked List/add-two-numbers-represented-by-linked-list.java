...
class GfG {
	...
	void addSameSize(Node start1, Node start2, LinkedList ans) { 
	    // Write code here
	      if(start1==null && start2 ==null){
            return;
        }
        addSameSize(start1.next,start2.next,ans);
        int sum = start1.data+start2.data+carry;
        int nd = sum%10;
        carry = sum/10;
        ans.push(nd);
    }
